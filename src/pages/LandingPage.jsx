  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-1000 ${scheme.bg} ${scheme.text} font-sans`}>
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 px-6">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">ToggleBox</h1>
        <p className="text-xl md:text-2xl opacity-80 mb-8">Real-time CSS Preview Engine — simple, calm, focused on color.</p>
        <Link
          to="/interactive"
        ...
        <div className="mt-12 max-w-4xl w-full border rounded-xl shadow-sm bg-white">
          <div className="rounded-xl p-12 text-gray-400">[Live preview screenshot placeholder]</div>
        </div>
      </section>

      <section className="py-20 px-6 border-t border-gray-100">
        <h2 className="text-3xl font-semibold text-center mb-12">Why ToggleBox?</h2>
